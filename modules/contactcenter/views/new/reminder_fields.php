...
<?php } ?>
<?php if (get_modules_active("contactcenter")) { ?>
  <div class="form-group">
    <div class="checkbox checkbox-primary">
      <input type="checkbox" name="notify_by_whatsapp" id="notify_by_whatsapp">
      <label for="notify_by_whatsapp"><?php echo _l('reminder_notify_me_by_whatsapp'); ?></label>
    </div>
  </div>
<?php } ?>