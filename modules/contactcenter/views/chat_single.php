                        ...
                        <div class="chat-container ">
                            <div class="chat-container-header ">
                                ...
                                <div class="footer-bar" style="display: flex; flex-direction: column; gap: 10px;">
                                    <!-- Slim search row - WhatsApp-like on mobile (only this visible by default) -->
                                    <div class="footer-bar-search-row">
                                        <div class="input-group footer-search-input">
                                            <span class="input-group-addon"><i class="fa-solid fa-magnifying-glass"></i></span>
                                            <input id="shearch" type="text" class="form-control footer-search-input-field" placeholder="<?= _l("contac_chat_search"); ?>">
                                        </div>
                                        <button type="button" class="btn btn-primary footer-mobile-btn footer-contacts-toggle" onclick="toggleContactsPanel()" aria-label="<?= _l("contac_chat_chat"); ?>">
                                            <i class="fa-solid fa-comment-dots"></i>
                                        </button>
                                        <button type="button" class="btn btn-primary footer-mobile-btn footer-accordion-toggle" onclick="toggleFooterAccordion()" aria-label="<?= _l("options"); ?>">
                                            <i class="fa-solid fa-chevron-down footer-accordion-icon"></i>
                                        </button>
                                        <a class="btn btn-primary footer-mobile-btn btn-filter-chat" href="<?= admin_url("contactcenter/chatall"); ?>">
                                            <i class="fa-solid fa-arrow-left"></i>
                                        </a>
                                    </div>

                                    <!-- Accordion: progress, filters, icons - collapsed on mobile -->
                                    <div class="footer-bar-accordion-content">
                                    <div class="footer-bar-top-row" style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                                        ...
                                        <div class="input-filter-chat footer-filters-only" style="flex: 1; display: flex; align-items: center; gap: 8px; flex-wrap: wrap;">
                                            <!-- Status Filter Badge -->
                                            ...
                                            <!-- Sort Filter Badge -->
                                            <div class="chat-filter-badge-wrapper" style="flex-shrink: 0;">
                                                <select class="form-control selectpicker chat-filter-select" id="chatSort" data-width="fit" data-size="5" data-style="btn-sm chat-filter-badge-select">
                                                    <option value="newest_first" selected><?= _l("chat_sort_newest_first"); ?></option>
                                                    <option value="oldest_first"><?= _l("chat_sort_oldest_first"); ?></option>
                                                    <option value="unread_first"><?= _l("chat_sort_unread_first"); ?></option>
                                                    <option value="read_first"><?= _l("chat_sort_read_first"); ?></option>
                                                    <option value="by_unread_date"><?= _l("chat_sort_by_unread_date"); ?></option>
                                                </select>
                                            </div>
                                            ...
                                            <!-- Desktop: search + filter + back (inside top row, hidden on mobile) -->
                                            <div class="footer-bar-desktop-actions">
                                                <div class="input-group footer-search-input" style="flex: 1; min-width: 180px;">
                                                    <span class="input-group-addon"><i class="fa-solid fa-magnifying-glass"></i></span>
                                                    <input id="shearch_desktop" type="text" class="form-control footer-search-input-field" placeholder="<?= _l("contac_chat_search"); ?>">
                                                </div>
                                                <div class="input-group filter-contact">
                                                    <div class="btn btn-primary btn-filter-chat" onclick="on_filter()"><i class="fa-solid fa-filter"></i></div>
                                                    <a class="btn btn-primary btn-filter-chat" href="<?= admin_url("contactcenter/chatall"); ?>"><i class="fa-solid fa-arrow-left"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                    <ul class="footer-bar-icons" style="width: 100%; margin-top: 0;">
                                        ...
                                        <?php if (is_admin()) { ?>
                                            <li id="onAi" class="btn btn-primary <?= ($device->dev_openai ? "active-ai" : "off-ai") ?>" data-toggle='tooltip' data-title='<?= _l("contac_chat_ai"); ?>' onclick="open_ai()"><img src="<?= base_url('modules/contactcenter/icon_omniU_white.png') ?>" alt="AI" class="onai-icon onai-icon-white" style="height:32px;width:auto;object-fit:contain;vertical-align:middle"><img src="<?= base_url('modules/contactcenter/icon_omniU_black.png') ?>" alt="AI" class="onai-icon onai-icon-black" style="height:32px;width:auto;object-fit:contain;vertical-align:middle"></li>
                                        <?php } ?>
                                        ...
                                        <!-- AXIOM Trigger Button -->
                                        <li class="axiom-trigger-btn" onclick="toggleAxiomDrawer()" data-toggle='tooltip' data-title='<?= _l("axiom_title"); ?>' style="list-style: none;">
                                            <img src="<?= base_url('modules/contactcenter/logo_axiom_white.png') ?>" alt="AXIOM" style="height:24px;width:auto;object-fit:contain;vertical-align:middle">
                                        </li>
                                    </ul>
                                    </div><!-- .footer-bar-accordion-content -->
                                </div>
                                        ...
                                        <div class="header-chat-modern">
                                            ...
                                            <div class="header-chat-info">
                                                <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                                                    <div class="box-dados-chat-modern" style="flex: 1; min-width: 0;">
                                                        <h5 id="lead-name" class="lead-name-modern"></h5>
                                                        <span id="lead-phone" class="lead-phone-modern"></span>
                                                        <div id="lead-birthday-wrap" class="lead-birthday-wrap" style="display: none; margin-top: 6px;">
                                                            <span id="lead-birthday-date" class="lead-birthday-date"></span>
                                                            <button type="button" id="lead-birthday-badge" class="lead-birthday-badge" style="display: none;" title="<?= _l('contac_birthday_click_send'); ?>"></button>
                                                            <button type="button" id="btn-edit-birthday" class="btn btn-xs btn-default" title="<?= _l('contac_lead_birthday_edit'); ?>"><i class="fa fa-pen"></i></button>
                                                            <input type="date" id="lead-birthday-input" class="form-control input-sm" style="display: none;" />
                                                            <button type="button" id="btn-save-birthday" class="btn btn-xs btn-success" style="display: none;"><i class="fa fa-check"></i></button>
                                                            <button type="button" id="btn-cancel-birthday" class="btn btn-xs btn-default" style="display: none;"><i class="fa fa-times"></i></button>
                                                        </div>
                                                        <?php if (!get_instance()->app_modules->is_inactive('si_lead_filters') && has_permission('si_lead_filters', '', 'view')) { ?>
                                                        <div id="lead-add-sale-wrap" class="lead-add-sale-wrap" style="display: none; margin-top: 6px;">
                                                            <button type="button" id="lead-add-sale-btn" class="btn btn-primary btn-sm si-lf-quick-add-sale-btn" title="<?= htmlspecialchars(_l('si_lf_sales_add')); ?>">
                                                                <i class="fa fa-plus"></i> <span id="lead-add-sale-label"><?= _l('si_lf_sales_add'); ?></span>
                                                            </button>
                                                            <span id="lead-add-sale-count" class="lead-add-sale-count" style="display: none;"><i class="fa fa-shopping-cart"></i> <span id="lead-add-sale-num">0</span></span>
                                                        </div>
                                                        <?php } ?>
                                                    </div>
                                                    <div class="header-chat-actions" style="display: flex; gap: 10px; align-items: center; flex-shrink: 0;">
                                                        <button id="btn-create-group" class="btn btn-sm btn-primary" onclick="manual_create_group_chat()" data-toggle="tooltip" data-title="<?= _l('contac_assistent_function_create_group_chat'); ?>" style="display: none; white-space: nowrap;">
                                                            <i class="fa fa-users"></i> <?= _l('contac_assistent_function_create_group_chat'); ?>
                                                        </button>
                                                    </div>
                                                </div>
                        ...
                        <article class="box-chat destacar">
                            <section class="chat-aside">
                                <div class="chat-perfil" style="position: relative;">
                                    ...
                                    <span class="chat-perfil-span"><img src="<?= base_url('modules/contactcenter/icon_axiom_w.png') ?>" alt="" class="chat-perfil-axiom-icon" style="height:50px;width:auto;object-fit:contain;vertical-align:middle;margin-right:6px"> <?= get_name_assistant($device->assistant_ai_id); ?></span>
                                    <span class="chat-perfil-span"><i class="fa-solid fa-mobile-screen-button"></i> <?= $device->dev_number ?></span>
                            ...
                            <section class="chat-body">
                                ...
                                <div class="smartchips-container" id="smartchipsContainer" style="display: none;"></div>
...
<!-- AXIOM Intelligent Overlay Drawer -->
<div class="axiom-drawer" id="axiomDrawer">
    <div class="axiom-drawer-header">
        <h3 class="axiom-drawer-title">
            <img src="<?= base_url('modules/contactcenter/logo_axiom_white.png') ?>" alt="AXIOM" class="axiom-drawer-logo" style="height:28px;width:auto;object-fit:contain;vertical-align:middle;margin-right:6px">
            <?= _l("axiom_title_suffix"); ?>
        </h3>
        <button class="axiom-drawer-close" onclick="toggleAxiomDrawer()">
            <i class="fa-solid fa-times"></i>
        </button>
    </div>

    <div class="axiom-drawer-body">
        <!-- ASK AXIOM - Top priority: Question bar -->
        <div class="axiom-feature-block axiom-ask-block" id="axiomAskBlock">
            <h4 class="axiom-feature-title axiom-ask-title">
                <i class="fa-solid fa-comments"></i>
                <?= _l("axiom_ask_title_prefix"); ?><img src="<?= base_url('modules/contactcenter/logo_axiom_white.png') ?>" alt="AXIOM" class="axiom-inline-logo" style="height:22px;width:auto;object-fit:contain;vertical-align:middle;margin:0 2px">
            </h4>
            <div class="deepquery-input-container">
                <input type="text" class="deepquery-input" id="deepQueryInput"
                    placeholder="<?= _l("axiom_ask_placeholder"); ?>">
                <button class="deepquery-submit" onclick="sendDeepQuery()">
                    <i class="fa-solid fa-paper-plane"></i>
                </button>
            </div>
            <div class="deepquery-response" id="deepQueryResponse" style="display: none;"></div>
        </div>

        <!-- Quick Reply - AI suggestions by context -->
        <div class="axiom-feature-block axiom-quickreply-priority" id="quickReplyBlock"
            data-thinking-1="<?= _l('axiom_thinking_analyzing') ?>"
            data-thinking-2="<?= _l('axiom_thinking_context') ?>"
            data-thinking-3="<?= _l('axiom_thinking_options') ?>">
            <h4 class="axiom-feature-title">
                <i class="fa-solid fa-paper-plane"></i>
                <?= _l("axiom_quick_reply"); ?>
            </h4>
            <div class="quickreply-controls">
                <label class="quickreply-label"><?= _l("axiom_quick_reply_context"); ?></label>
                <select class="quickreply-select" id="quickReplyContext">
                    <option value="last_message"><?= _l("axiom_context_last_message"); ?></option>
                    <option value="last_5"><?= _l("axiom_context_last_5"); ?></option>
                    <option value="last_10"><?= _l("axiom_context_last_10"); ?></option>
                    <option value="today"><?= _l("axiom_context_today"); ?></option>
                    <option value="full"><?= _l("axiom_context_full"); ?></option>
                </select>
                <div class="quickreply-registry">
                    <div class="quickreply-registry-section">
                        <label class="quickreply-label"><?= _l("axiom_quick_reply_objective"); ?></label>
                        <div id="quickReplyObjectivesList" class="quickreply-chips-list"></div>
                        <div class="quickreply-add-row">
                            <input type="text" class="quickreply-input" id="quickReplyObjectiveNew" placeholder="<?= _l("axiom_quick_reply_add_objective"); ?>" maxlength="80">
                            <button type="button" class="quickreply-add-btn" id="quickReplyAddObjectiveBtn" title="<?= _l("axiom_quick_reply_add"); ?>"><i class="fa-solid fa-plus"></i></button>
                        </div>
                    </div>
                    <div class="quickreply-registry-section">
                        <label class="quickreply-label"><?= _l("axiom_quick_reply_product"); ?></label>
                        <div id="quickReplyProductsList" class="quickreply-chips-list"></div>
                        <div class="quickreply-add-row">
                            <input type="text" class="quickreply-input" id="quickReplyProductNew" placeholder="<?= _l("axiom_quick_reply_add_product"); ?>" maxlength="80">
                            <button type="button" class="quickreply-add-btn" id="quickReplyAddProductBtn" title="<?= _l("axiom_quick_reply_add"); ?>"><i class="fa-solid fa-plus"></i></button>
                        </div>
                    </div>
                </div>
                <button type="button" class="quickreply-generate-btn" id="quickReplyGenerateBtn" onclick="generateQuickReplies()">
                    <i class="fa-solid fa-wand-magic-sparkles"></i> <?= _l("axiom_quick_reply_generate"); ?>
                </button>
            </div>
            <div id="quickReplyThinking" class="quickreply-thinking" style="display: none;">
                <div class="quickreply-thinking-dots"><span></span><span></span><span></span></div>
                <div class="quickreply-thinking-text" id="quickReplyThinkingText"></div>
            </div>
            <div id="quickReplySuggestions" class="quickreply-suggestions" style="display: none;"></div>
        </div>

        <!-- EchoSense - Audio Intelligence -->
        <div class="axiom-feature-block" id="echoSenseBlock" style="display: none;">
            <h4 class="axiom-feature-title">
                <i class="fa-solid fa-microphone"></i>
                <?= _l("axiom_echo_sense"); ?>
            </h4>
            <div id="echoSenseContent">
                <div class="echosense-player">
                    <div class="echosense-audio-info">
                        <span style="color: rgba(255,255,255,0.7); font-size: 13px;">Audio detected</span>
                        <button class="echosense-toggle-transcript" onclick="toggleTranscript()">
                            <i class="fa-solid fa-text"></i> <?= _l("axiom_show_transcript"); ?>
                        </button>
                    </div>
                    <div class="echosense-transcript" id="echoSenseTranscript"></div>
                </div>
            </div>
        </div>

        <!-- FlowSync - Auto Actions -->
        <div id="flowSyncContainer"></div>

        <!-- DealPulse, ClientDNA, StratPath - Collapsible, load on expand -->
        <div class="axiom-collapsible-section axiom-collapsed" id="dealPulseSection" data-feature="deal_pulse">
            <h4 class="axiom-collapsible-title" onclick="toggleAxiomSection('dealPulseSection')">
                <i class="fa-solid fa-chevron-right axiom-chevron"></i>
                <i class="fa-solid fa-chart-line"></i>
                <?= _l("axiom_deal_pulse"); ?>
            </h4>
            <div class="axiom-collapsible-content">
                <div class="dealpulse-gauge" id="dealPulseGauge">
                    <div class="axiom-shimmer axiom-shimmer-dealpulse" id="dealPulseShimmer"></div>
                    <div id="dealPulseContent" style="display: none;">
                        <div class="dealpulse-progress">
                            <div class="dealpulse-progress-bar" id="dealPulseBar" style="width: 0%;"></div>
                        </div>
                        <div class="dealpulse-score" id="dealPulseScore">0%</div>
                        <div class="dealpulse-label" id="dealPulseLabel"><?= _l("axiom_analyzing"); ?></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="axiom-collapsible-section axiom-collapsed" id="clientDNASection" data-feature="client_dna">
            <h4 class="axiom-collapsible-title" onclick="toggleAxiomSection('clientDNASection')">
                <i class="fa-solid fa-chevron-right axiom-chevron"></i>
                <i class="fa-solid fa-dna"></i>
                <?= _l("axiom_client_dna"); ?>
            </h4>
            <div class="axiom-collapsible-content">
                <div id="clientDNAContent">
                    <div class="axiom-shimmer" id="clientDNAShimmer" style="height: 100px;"></div>
                    <div id="clientDNAAnalysis" style="display: none;">
                        <div class="clientdna-sentiment">
                            <span class="clientdna-emoji" id="clientDNAEmoji">🤔</span>
                            <span class="clientdna-label" id="clientDNALabel"><?= _l("axiom_analyzing"); ?></span>
                        </div>
                        <div class="clientdna-tags" id="clientDNATags"></div>
                    </div>
                </div>
            </div>
        </div>
        <div class="axiom-collapsible-section axiom-collapsed" id="stratPathSection" data-feature="strat_path">
            <h4 class="axiom-collapsible-title" onclick="toggleAxiomSection('stratPathSection')">
                <i class="fa-solid fa-chevron-right axiom-chevron"></i>
                <i class="fa-solid fa-route"></i>
                <?= _l("axiom_strat_path"); ?>
            </h4>
            <div class="axiom-collapsible-content">
                <div id="stratPathContent">
                    <div class="axiom-shimmer" id="stratPathShimmer" style="height: 150px;"></div>
                    <div class="stratpath-cards" id="stratPathCards" style="display: none;"></div>
                </div>
            </div>
        </div>

        <!-- AXIOM Timing Debug (visible when ?axiom_debug=1 or window.axiomDebugEnabled = true) -->
        <div id="axiomDebugContainer" class="axiom-feature-block" style="display: none; margin-top: 12px;">
            <h4 class="axiom-feature-title" style="font-size: 12px; opacity: 0.8;">
                <i class="fa-solid fa-clock"></i> <img src="<?= base_url('modules/contactcenter/logo_axiom_white.png') ?>" alt="AXIOM" class="axiom-inline-logo" style="height:16px;width:auto;object-fit:contain;vertical-align:middle;margin:0 2px"> <?= _l("axiom_debug_title"); ?>
            </h4>
            <div id="axiomDebugPanel" style="max-height: 120px; overflow-y: auto; font-family: monospace; font-size: 11px; color: rgba(255,255,255,0.7); line-height: 1.6;"></div>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    var chatMarkedRead = null; // Global variable for chat marked read filter
    var chatSort = "newest_first"; // Global variable for chat sort filter
    var hasMoreDataFlag = true; // Global flag para controlar carregamento infinito
    ...
    $(document).ready(function() {
        ...
        setInterval(load_campaign_queue_status, 30000);

        // Load and start follow-up queue status monitoring
        load_followup_queue_status();
        // Refresh every 10 seconds
        setInterval(load_followup_queue_status, 30000);
        ...
        $("#shearch, #shearch_desktop").on("keyup", function() {
            var value = $(this).val().toLowerCase();
            var $other = $(this).attr('id') === 'shearch' ? $('#shearch_desktop') : $('#shearch');
            if ($other.length) $other.val($(this).val());
        ...
        $('#shearch, #shearch_desktop').on('keyup', function() {
            ...
            var $other = $(this).attr('id') === 'shearch' ? $('#shearch_desktop') : $('#shearch');
            if ($other.length) $other.val(searchTerm);
        ...
        ajaxRequest = $.ajax({
            ...
            success: function(data) {
                ...
                if (data.phonenumber) {
                    ...
                    // Store lead ID for manual group creation
                    $('#btn-create-group').attr('data-lead-id', data.id).attr('data-phonenumber', data.phonenumber).show();
                    update_lead_birthday_ui(data);
                    update_lead_add_sale_ui(data);
                } else {
                    $('.header-chat-modern, .header-chat-content').css("display", "none");
                    $('#btn-create-group').hide();
                    $('#lead-birthday-wrap').hide();
                    $('#lead-add-sale-wrap').hide();
                }
                if (data.gpt_status) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.phonenumber) {
                    ...
                    // Update contact list row name if group name was fetched/updated
                    var row = $('tr[data-id="' + id + '"]');
                    if (row.length > 0 && data.name) {
                        // Update the name in the contact list (in the h1 tag inside the row)
                        // Check if there's a marked read icon to preserve it
                        var h1Element = row.find('h1').first();
                        var existingHtml = h1Element.html();
                        var markedReadIcon = h1Element.find('i').first();

                        if (markedReadIcon.length > 0) {
                            // Preserve the icon and update the text
                            h1Element.html(markedReadIcon.prop('outerHTML') + ' ' + data.name);
                        } else {
                            // Just update the text
                            h1Element.text(data.name);
                        }

                        // Update the profile picture if provided
                        if (data.thumb || data.picture) {
                            var imgElement = row.find('img').first();
                            if (imgElement.length > 0) {
                                imgElement.attr('src', data.thumb || data.picture);
                                console.log("Updated contact list picture for " + id);
                            }
                        }

                        // Also update the row's data attribute if it exists
                        row.attr('data-name', data.name);

                        console.log("Updated contact list name for " + id + " to: " + data.name);
                    }
                } else {
                    $('.header-chat-modern, .header-chat-content').css("display", "none");
                    $('#btn-create-group').hide();
            ...
            error: function(xhr, status, err) {
                ...
                $(".spinner-load-chat").fadeOut();
                if (status === 'timeout') {
                    $('#retorno').html("<div class='no-results' style='padding:20px;text-align:center;color:#999;'>Request timed out. Please try again.</div>");
                }
            }
        });
    }
    ...
    function get_contact() {
        ...
        chatMarkedRead = $("#chatMarkedRead").val();
        if (chatMarkedRead !== "") {
        ...
        chatSort = $("#chatSort").val();
        if (!chatSort || chatSort === "") {
            chatSort = "newest_first";
        }
        ...
        // When staffid is 0 or on localhost, send device token for fetch by session (local env fallback)
        var deviceToken = $("input[name='token']").val();
        if (deviceToken && (!tokenUser || (typeof window !== 'undefined' && window.location && (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1')))) {
            ajaxData.device_token = deviceToken;
        }
        ...
        ajaxRequest = $.ajax({
            ...
            success: function(data) {
                ...
                if (data.retorno) {
                    ...
                    // Reseta a flag de carregamento infinito quando um novo filtro é aplicado
                    window.hasMoreDataFlag = true;

                } else {
                    $('#contaChat tbody').html("<tr><td>Not Result</td></tr>");
                    window.hasMoreDataFlag = false;
                }
    ...
    function new_chat() {
        // Filter for unreplied messages (msg_fromMe = 0 means incoming messages not replied to yet)
        var checkbox = $('#msg_fromMe');
        if (!checkbox.is(':checked')) {
            checkbox.prop('checked', true);
            $('#checkBtn').css("background", "var(--primary)");
        }

        // Refresh the contact list with the filter applied
        get_contact();
    ...
    function toggleFooterAccordion() {
        var $accordion = $(".footer-bar-accordion-content");
        var $icon = $(".footer-accordion-icon");
        var isOpening = !$accordion.is(":visible");
        if (isOpening) {
            $accordion.slideDown(200, function() {
                $icon.removeClass("fa-chevron-down").addClass("fa-chevron-up");
                $accordion.addClass("footer-accordion-expanded");
            });
        } else {
            $accordion.removeClass("footer-accordion-expanded");
            $accordion.slideUp(200, function() {
    ...
    function toggleContactsPanel() {
        ...
        if ($boxChat.hasClass("contacts-panel-closed")) {
            $boxChat.removeClass("contacts-panel-closed");
            $(".footer-bar-accordion-content").slideUp(200);
            $(".footer-accordion-icon").removeClass("fa-chevron-up").addClass("fa-chevron-down");
        } else {
            $boxChat.addClass("contacts-panel-closed");
            $(".footer-bar-accordion-content").slideUp(200);
            $(".footer-accordion-icon").removeClass("fa-chevron-up").addClass("fa-chevron-down");
        }
    }
    ...
    $(document).ready(function() {
        var isLoading = false;
        var lastScrollTop = 0; // Para detectar scroll para cima
        var lastRequestTime = 0; // Para evitar requisições muito frequentes
        var REQUEST_DELAY = 500; // Delay mínimo entre requisições em ms
        ...
        $('.chat-aside section').on('scroll', function() {
            ...
            // Se o usuário faz scroll para cima (scrollTop atual menor que anterior), reativa o carregamento
            if (scrollTop < lastScrollTop - 50) { // Tolerância de 5px para evitar falsos positivos              
                hasMoreDataFlag = true;
            }

            // Atualiza lastScrollTop SEMPRE ao final
            lastScrollTop = scrollTop;

            // Verifica se o usuário chegou ao final da div (com margem de 5px de tolerância)
            if (scrollTop + innerHeight >= scrollHeight - 5) {


                // Só carrega se há mais dados e não está já carregando
                if (!isLoading && hasMoreDataFlag) {
                    isLoading = true;
                    ...
                    var devToken = $("input[name='token']").val();
                    if (devToken && (!<?= $device->staffid ?> || (typeof window !== 'undefined' && window.location && (window.location.hostname === 'localhost' || window.location.hostname === '127.0.0.1')))) {
                        paginadorData.device_token = devToken;
                    }
                    $.ajax({
                        ...
                        success: function(data) {
                            if (data.retorno) {
                                ...
                                // Se não houver mais dados, desativa o carregamento
                        ...
                        error: function(xhr, status, error) {
                            ...
                            $(".load-get-msg").fadeOut();
                            isLoading = false;
                            // Em caso de erro, também desativa para não ficar tentando continuamente
                            hasMoreDataFlag = false;
                        }
                    });
                } else if (!hasMoreDataFlag) {
    ...
    var _leadBirthdayFieldId = null;
    var _leadIdForBirthday = null;

    function fmtBirthdayDDMMYYYY(val) {
        if (!val) return '';
        var d = new Date(val);
    ...
    function getBirthdayOccasion(birthdayStr) {
        if (!birthdayStr) return null;
        var d = new Date(birthdayStr);
        var today = new Date();
        today.setHours(0, 0, 0, 0);
        var bdThisYear = new Date(today.getFullYear(), d.getMonth(), d.getDate());
        bdThisYear.setHours(0, 0, 0, 0);
        var diffMs = bdThisYear - today;
        var diffDays = Math.round(diffMs / (24 * 60 * 60 * 1000));
        var labels = <?= json_encode([
            'today' => _l('contac_birthday_label_today'),
            'tomorrow' => _l('contac_birthday_label_tomorrow'),
            'yesterday' => _l('contac_birthday_label_yesterday'),
            'in_days' => _l('contac_birthday_label_in_days'),
            'next_week' => _l('contac_birthday_label_next_week'),
            'next_month' => _l('contac_birthday_label_next_month'),
            'days_ago' => _l('contac_birthday_label_days_ago'),
            'last_week' => _l('contac_birthday_label_last_week')
        ]); ?>;
        var presets = <?= json_encode([
            'today' => _l('contac_birthday_preset_today'),
            'tomorrow' => _l('contac_birthday_preset_tomorrow'),
            'yesterday' => _l('contac_birthday_preset_yesterday'),
            'in_days' => _l('contac_birthday_preset_in_days'),
            'next_week' => _l('contac_birthday_preset_next_week'),
            'next_month' => _l('contac_birthday_preset_next_month'),
            'days_ago' => _l('contac_birthday_preset_days_ago'),
            'last_week' => _l('contac_birthday_preset_last_week')
        ]); ?>;
        if (diffDays === 0) return { key: 'today', label: labels.today, preset: presets.today, css: 'lead-birthday-today' };
        if (diffDays === 1) return { key: 'tomorrow', label: labels.tomorrow, preset: presets.tomorrow, css: 'lead-birthday-tomorrow' };
        if (diffDays === -1) return { key: 'yesterday', label: labels.yesterday, preset: presets.yesterday, css: 'lead-birthday-yesterday' };
        if (diffDays >= 2 && diffDays <= 6) return { key: 'in_days', label: labels.in_days.replace('%s', diffDays), preset: presets.in_days.replace('%s', diffDays), css: 'lead-birthday-soon' };
        if (diffDays >= 7 && diffDays <= 14) return { key: 'next_week', label: labels.next_week, preset: presets.next_week, css: 'lead-birthday-soon' };
        if (diffDays >= 15) return { key: 'next_month', label: labels.next_month, preset: presets.next_month, css: 'lead-birthday-later' };
        if (diffDays <= -2 && diffDays >= -6) return { key: 'days_ago', label: labels.days_ago.replace('%s', Math.abs(diffDays)), preset: presets.days_ago.replace('%s', Math.abs(diffDays)), css: 'lead-birthday-past' };
        if (diffDays <= -7 && diffDays >= -14) return { key: 'last_week', label: labels.last_week, preset: presets.last_week, css: 'lead-birthday-past' };
        if (diffDays <= -15) return { key: 'days_ago', label: labels.days_ago.replace('%s', Math.abs(diffDays)), preset: presets.days_ago.replace('%s', Math.abs(diffDays)), css: 'lead-birthday-past' };
        return null;
    }

    function sendBirthdayPreset(preset) {
        var textarea = $("#textarea-chat");
        if (textarea[0] && textarea[0].emojioneArea) {
            textarea[0].emojioneArea.setText(preset);
        } else {
            textarea.val(preset);
        }
        $("textarea[name='msg']").val(preset);
        $("#btn_submit").removeClass("hidden");
        $("#startRecording").addClass("hidden");
        $("#btn_submit").prop("disabled", false);
        $("#btn_submit").css("background", "var(--primary)");
        setTimeout(function() { $("form[name='sendMsg']").submit(); }, 50);
    }

    function update_lead_birthday_ui(data) {
        var wrap = $('#lead-birthday-wrap');
        var hasFields = <?= json_encode(!empty($birthday_custom_fields)); ?>;
        if (!data.id || data.id == 0 || !hasFields) {
            wrap.hide();
            return;
        }
        _leadIdForBirthday = data.id;
        _leadBirthdayFieldId = data.birthday_field_id || null;
        if (data.birthday || _leadBirthdayFieldId) {
            wrap.show();
            var $date = $('#lead-birthday-date');
            var $badge = $('#lead-birthday-badge');
            $date.removeClass('lead-birthday-today lead-birthday-tomorrow lead-birthday-yesterday lead-birthday-soon lead-birthday-later lead-birthday-past').show();
            $badge.removeClass('lead-birthday-today lead-birthday-tomorrow lead-birthday-yesterday lead-birthday-soon lead-birthday-later lead-birthday-past').off('click').hide();
            if (data.birthday) {
                var fmt = fmtBirthdayDDMMYYYY(data.birthday);
                $date.html('<i class="fa-solid fa-gift" style="margin-right:4px;color:#00b87a;"></i>' + fmt);
                var occasion = getBirthdayOccasion(data.birthday);
                if (occasion) {
                    $badge.text(occasion.label).addClass(occasion.css).data('preset', occasion.preset).show().on('click', function() {
                        sendBirthdayPreset(occasion.preset);
                    });
                }
            } else {
                $date.html('<i class="fa-solid fa-gift" style="margin-right:4px;color:#999;"></i><?= addslashes(_l('contac_lead_birthday_add')); ?>');
            }
            $('#lead-birthday-input').val(data.birthday || '').hide();
            $('#btn-save-birthday, #btn-cancel-birthday').hide();
            $('#btn-edit-birthday').show();
        } else {
            wrap.hide();
        }
    }

    $('#btn-edit-birthday').on('click', function() {
        if (!_leadBirthdayFieldId) return;
        $('#lead-birthday-date, #lead-birthday-badge').hide();
        $(this).hide();
        $('#lead-birthday-input').show().focus();
        $('#btn-save-birthday, #btn-cancel-birthday').show();
    });
    $('#btn-cancel-birthday').on('click', function() {
        $('#lead-birthday-input').hide();
        $('#btn-save-birthday, #btn-cancel-birthday').hide();
        $('#lead-birthday-date, #lead-birthday-badge').show();
        $('#btn-edit-birthday').show();
    });
    $('#btn-save-birthday').on('click', function() {
        if (!_leadIdForBirthday || !_leadBirthdayFieldId) return;
        var val = $('#lead-birthday-input').val();
        $.post(site_url + 'admin/contactcenter/ajax_save_lead_birthday', {
            lead_id: _leadIdForBirthday,
            field_id: _leadBirthdayFieldId,
            value: val
        }, 'json').done(function(r) {
            if (r.success) {
                update_lead_birthday_ui({ id: _leadIdForBirthday, birthday: val, birthday_field_id: _leadBirthdayFieldId });
            }
            $('#lead-birthday-input').hide();
            $('#btn-save-birthday, #btn-cancel-birthday').hide();
            $('#btn-edit-birthday').show();
    ...
    function update_lead_add_sale_ui(data) {
        var $wrap = $('#lead-add-sale-wrap');
        ...
        $wrap.show();
        $('#lead-add-sale-btn').attr('data-lead-id', data.id);
        var cnt = parseInt(data.sales_count, 10) || 0;
        var $countEl = $('#lead-add-sale-count');
        var $numEl = $('#lead-add-sale-num');
        if (cnt > 0) {
            $numEl.text(cnt);
            $countEl.show();
        } else {
    ...
    $('#lead-add-sale-btn').on('click', function() {
        var leadId = $(this).attr('data-lead-id');
        if (!leadId || leadId == '0') return;
        if (typeof init_lead !== 'function') return;
        window._contactcenterOpenAddSale = parseInt(leadId, 10);
        init_lead(leadId);
    });

    $(document).on('shown.bs.modal', '#lead-modal', function() {
        if (window._contactcenterOpenAddSale) {
            delete window._contactcenterOpenAddSale;
            var $salesTab = $('a[href="#tab_si_lf_sales"]');
            var $saleModal = $('#si-lf-sale-modal');
            if ($salesTab.length && $saleModal.length) {
                $salesTab.tab('show');
                $saleModal.appendTo('body');
                setTimeout(function() { $saleModal.modal('show'); }, 300);
            }
        }
    });
...
<style>
    ...
    /* Dark theme - footer bar filters */
    #wrapper[theme="dark"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-toggle.chat-filter-badge-select,
    #wrapper[theme="1"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-toggle.chat-filter-badge-select {
        border-color: rgba(255, 255, 255, 0.2) !important;
        background: rgba(255, 255, 255, 0.08) !important;
        color: rgba(255, 255, 255, 0.95) !important;
    }

    #wrapper[theme="dark"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-toggle.chat-filter-badge-select:focus,
    #wrapper[theme="dark"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-toggle.chat-filter-badge-select:hover,
    #wrapper[theme="1"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-toggle.chat-filter-badge-select:focus,
    #wrapper[theme="1"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-toggle.chat-filter-badge-select:hover {
    ...
    #wrapper[theme="dark"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-menu,
    #wrapper[theme="1"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-menu {
        background: rgba(30, 30, 30, 0.98) !important;
        border-color: rgba(255, 255, 255, 0.15) !important;
    }

    #wrapper[theme="dark"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-menu li a,
    #wrapper[theme="1"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-menu li a {
        color: rgba(255, 255, 255, 0.9) !important;
    }

    #wrapper[theme="dark"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-menu li a:hover,
    #wrapper[theme="1"] .footer-bar .chat-filter-badge-wrapper .bootstrap-select .dropdown-menu li a:hover {
    ...
    #onAi.btn-primary.off-ai .onai-icon-white {
        display: inline-block;
    }
    #onAi.btn-primary.off-ai .onai-icon-black {
        display: none;
    }

    #onAi.btn-primary.active-ai {
        background: var(--primary) !important;
        /* Normal primary color when AI is on */
    }

    #onAi.btn-primary.active-ai .onai-icon-white {
        display: none;
    }
    #onAi.btn-primary.active-ai .onai-icon-black {
        display: inline-block;
    }
    ...
    .lead-birthday-wrap { display: flex; align-items: center; gap: 6px; flex-wrap: wrap; }
    .lead-birthday-date { font-size: 12px; color: rgba(255,255,255,0.6); }
    .lead-birthday-badge {
        font-size: 11px; font-weight: 700; padding: 3px 8px; border-radius: 4px; cursor: pointer;
        border: none; transition: transform 0.15s, box-shadow 0.15s;
    }
    .lead-birthday-badge:hover { transform: scale(1.05); box-shadow: 0 2px 8px rgba(0,0,0,0.3); }
    .lead-birthday-today {
        color: #fff !important; font-size: 12px;
        background: linear-gradient(135deg, #00e09b 0%, #00b87a 100%);
        box-shadow: 0 0 12px rgba(0,224,155,0.5);
        animation: lead-birthday-glow 1.5s ease-in-out infinite;
    }
    .lead-birthday-tomorrow { background: rgba(0,200,150,0.4); color: #fff !important; }
    .lead-birthday-yesterday { background: rgba(150,150,150,0.5); color: rgba(255,255,255,0.9) !important; }
    .lead-birthday-soon { background: rgba(0,180,120,0.35); color: rgba(255,255,255,0.95) !important; }
    .lead-birthday-later { background: rgba(255,255,255,0.15); color: rgba(255,255,255,0.85) !important; }
    .lead-birthday-past { background: rgba(255,255,255,0.1); color: rgba(255,255,255,0.7) !important; }
    .lead-add-sale-wrap { display: inline-flex; align-items: center; }
    .lead-add-sale-wrap .si-lf-quick-add-sale-btn { white-space: nowrap; }
    .lead-add-sale-count { margin-left: 6px; font-size: 11px; color: rgba(255,255,255,0.9); font-weight: 600; }
    .lead-add-sale-count i { margin-right: 2px; opacity: 0.9; }
    #lead-birthday-input { background: rgba(255,255,255,0.1); border: 1px solid rgba(255,255,255,0.2); color: #fff; width: 140px; height: 26px; padding: 2px 8px; font-size: 12px; border-radius: 4px; }
    #lead-birthday-input:focus { background: rgba(255,255,255,0.15); border-color: #00e09b; outline: none; }
    #lead-birthday-input::-webkit-calendar-picker-indicator { filter: invert(1); opacity: 0.7; cursor: pointer; }
    @keyframes lead-birthday-glow { 0%,100% { box-shadow: 0 0 12px rgba(0,224,155,0.5); } 50% { box-shadow: 0 0 20px rgba(0,224,155,0.8); } }
    ...
    /* Footer Icons List */
    .footer-bar ul.footer-bar-icons {
        display: flex;
        align-items: center;
        gap: 8px;
        margin: 0;
    ...
    .footer-bar ul.footer-bar-icons>li,
    .footer-bar ul.footer-bar-icons>a {
        display: flex;
        align-items: center;
        justify-content: center;
    }

    .footer-bar ul.footer-bar-icons .btn-primary {
        width: 40px;
        height: 40px;
        padding: 0;
        border-radius: 8px;
    ...
    .footer-bar ul.footer-bar-icons .btn-primary:hover {
        background: rgba(255, 255, 255, 0.12);
        border-color: rgba(255, 255, 255, 0.25);
        transform: translateY(-2px);
        box-shadow: 0 4px 8px rgba(0, 0, 0, 0.15);
    ...
    .footer-bar ul.footer-bar-icons .btn-primary i {
        color: #ffffff;
        font-size: 16px;
        line-height: 1;
        display: flex;
    ...
    .footer-bar ul.footer-bar-icons .btn-primary input[type="checkbox"] {
        position: absolute;
        opacity: 0;
        width: 100%;
        height: 100%;
    ...
    .footer-bar ul.footer-bar-icons .btn-primary input[type="checkbox"]+i {
        position: relative;
        z-index: 0;
    }

    .footer-bar ul.footer-bar-icons .btn-primary.active-ai i {
        color: #00e09b;
    }

    .footer-bar ul.footer-bar-icons .btn-primary.off-ai i {
        color: #e83a30;
    }
    ...
    @media (max-width: 768px) {
        .footer-bar .input-filter-chat {
            flex-direction: row !important;
            flex-wrap: nowrap !important;
        }

        .footer-bar .chat-filter-badge-wrapper {
            width: auto !important;
        }
    }
</style>
...
<script>
    ...
    function start_chat_with_message() {
        ...
        console.log('New chat - Validation check:', {
            hasMessage: !!message,
            hasMedia: hasMedia,
            mediaPath: mediaPath,
            mediaType: mediaType
        ...
        if (typeof get_message_contact_search === 'function') {
            ...
            setTimeout(function() {
                console.log('Attempting to send after chat load:', {
                    phoneNumber: phoneNumber,
                    message: message,
                    mediaId: mediaId,
                    mediaPath: mediaPath
    ...
    function send_initial_message(phoneNumber, message) {
        if (!message || !phoneNumber) {
            console.log('send_initial_message: Missing message or phoneNumber', {
                message: message,
                phoneNumber: phoneNumber
            });
            return;
        ...
        sendingMessage = true;
        console.log('send_initial_message: Starting send process', {
            phoneNumber: phoneNumber,
            message: message
        });
    ...
    function select_media_for_new_chat(mediaId, filePath, fileName, fileType) {
        console.log('select_media_for_new_chat called:', {
            mediaId: mediaId,
            filePath: filePath,
            fileName: fileName,
            fileType: fileType
    ...
    function send_media_from_new_chat(phoneNumber, mediaId, filePath, fileType, textMessage) {
        ...
        console.log('New chat: Sending media', {
            mediaId: mediaId,
            filePath: filePath,
            fileType: fileType,
            phoneNumber: phoneNumber
        ...
        $.ajax({
            ...
            error: function(xhr, status, error) {
                ...
                $('.loading-message').remove();
                console.error('New chat: Error sending media', {
                    xhr: xhr,
                    status: status,
                    error: error
                });
...
<style>
    ...
    .media-item-type-badge.audio {
        background-color: #4CAF50;
        color: white;
    }

    .media-item-type-badge.image {
        background-color: #2196F3;
        color: white;
    }

    .media-item-type-badge.video {
        background-color: #FF9800;
        color: white;
    }

    .media-item-type-badge.document {
...
<script>
    ...
    function update_bulk_send_progress(current, total) {
        ...
        if (isNaN(current) || isNaN(total)) {
            console.error('update_bulk_send_progress called with invalid values:', {
                current: current,
                total: total
            });
            return;
            ...
            success: function(response) {
                if (response.success) {
                    if (response.has_campaign) {
                        ...
                        // Display sent/total format: "5 enviadas / 20 total" or "5 sent / 20 total"
                        var totalLeads = response.total_leads || 0;
                        var sentLeads = response.sent_leads || 0;
                        var pendingLeads = response.pending_count || (totalLeads - sentLeads);

                        // Format: "X sent / Y total" or similar based on language
                        var displayText = sentLeads + ' / ' + totalLeads + ' <?= _l("pending_messages"); ?>';
                        if (sentLeads > 0) {
                            // If there are sent leads, show "X sent / Y total leads"
                            displayText = sentLeads + ' <?= _l("omni_pilot_sent"); ?> / ' + totalLeads;
                        }
                        $('#campaignQueueText').text(displayText);

                        // Update progress bar
                        var progressPercent = totalLeads > 0 ? Math.round((sentLeads / totalLeads) * 100) : 0;
                        $('#campaignQueueBar').css('width', progressPercent + '%');
                        $('#campaignQueueBar').attr('aria-valuenow', progressPercent);
                        $('#campaignQueueBar').attr('data-percent', progressPercent);
            ...
            success: function(response) {
                if (response.success) {
                    if (response.has_followup) {
                        ...
                        $('#followupQueueName').text(response.followup_name || '<?= _l("active_followup"); ?>');

                        // Display sent/total format: "5 sent / 20 total" or "5 enviados / 20 total"
                        var totalLeads = response.total_leads || 0;
                        var sentLeads = response.sent_leads || 0;
                        var pendingLeads = response.pending_count || (totalLeads - sentLeads);

                        var displayText = sentLeads + ' <?= _l("omni_pilot_sent"); ?> / ' + totalLeads;
                        if (sentLeads === 0) {
                            displayText = totalLeads + ' <?= _l("pending_leads"); ?>';
                        }
                        $('#followupQueueText').text(displayText);

                        // Update progress bar
                        var progressPercent = totalLeads > 0 ? Math.round((sentLeads / totalLeads) * 100) : 0;
                        $('#followupQueueBar').css('width', progressPercent + '%');
                        $('#followupQueueBar').attr('aria-valuenow', progressPercent);
                        $('#followupQueueBar').attr('data-percent', progressPercent);
...
<?php if (is_admin()) { ?>
    ...
    <script>
        ...
        // Manual group creation function
        function manual_create_group_chat() {
            var leadId = $('#btn-create-group').attr('data-lead-id');
            var phonenumber = $('#btn-create-group').attr('data-phonenumber');
            var deviceId = $("input[name='device_id']").val();

            if (!leadId || !phonenumber || !deviceId) {
                alert_float('danger', '<?= _l("error_creating_group_missing_data"); ?>');
                return;
            }

            if (!confirm('<?= _l("confirm_create_group_chat"); ?>')) {
                return;
            }

            // Disable button and show loading
            var $btn = $('#btn-create-group');
            var originalHtml = $btn.html();
            $btn.prop('disabled', true).html('<i class="fa fa-spinner fa-spin"></i> <?= _l("creating"); ?>...');

            $.ajax({
                url: site_url + 'admin/contactcenter/ajax_manual_create_group',
                data: {
                    lead_id: leadId,
                    phonenumber: phonenumber,
                    device_id: deviceId
                ...
                success: function(response) {
                    if (response.success === "true" || response.success === true) {
                        alert_float('success', response.message || '<?= _l("group_created_successfully"); ?>');
                    } else {
                        alert_float('danger', response.message || '<?= _l("error_creating_group"); ?>');
                    }
